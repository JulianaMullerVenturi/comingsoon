document.addEventListener('DOMContentLoaded', () => {
    ...
    // Stripped negative sign to correctly map shadow projecting away from light source
    const ds1_base_x = 92;
    const ds1_base_y = 188;
    
    // Drop Shadow 2 (Difference) Base State
    // Calibrated proportional lateral offset
    const ds2_base_x = 38;
    const ds2_base_y = 78;

    // Drop Shadow 3 (Far Background Glow) Base State
    // Placed extremely far away to act as an ambient spill light
    ...
    function cacheLayout() {
        ...
        ds1Blur.setAttribute('stdDeviation', 87.5 / avgScale);
        ds2Blur.setAttribute('stdDeviation', 47.5 / avgScale);
        ds3Blur.setAttribute('stdDeviation', 180 / avgScale);
